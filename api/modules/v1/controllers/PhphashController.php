...
class PhphashController extends ActiveController
{
...
//        header("Content-type:image/png;");
     ...
     * @return bool 当图片相似则传递 true，否则是 false
     * */
    function Isimagefilesimilar($aPath,$bHash){
//        $aPath = $_GET['apath'];
//        $bPath = $_GET['bpath'];
//        for($i=91;$i<108256;$i++){
//            $img_name = Goods::find()->select('id,image')->where(['id'=>$i])->one();
//            if($img_name){
//                $aHash = $this->hashImageFile('http://qiniu.zaoanart.com/'.$img_name['image']);
//                Goods::updateAll(['hash_str' => $aHash], ['id'=>$img_name['id']]);
//            }
//        }
