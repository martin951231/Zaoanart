 ...
 */
class Goodscount extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['search_sum','search_sum_wechat','decoration_sum','decoration_sum_wechat','keep_sum','keep_sum_wechat',],'number'],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'updated_at' => '更新时间',
            'search_sum' => 'PC访问次数',
            'search_sum_wechat' => '小程序访问次数',
            'decoration_sum' => 'PC装裱次数',
            'decoration_sum_wechat' => '小程序装裱次数',
            'keep_sum' => 'PC收藏次数',
            'keep_sum_wechat' => '小程序收藏次数',
        ];
    }
}
