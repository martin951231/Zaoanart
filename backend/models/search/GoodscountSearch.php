 ...
 */
class GoodscountSearch extends Goodscount
{
    ...
    public function rules()
    {
        return [
            ...
            [['max_length', 'max_width', 'min_length', 'min_width', 'price', 'premium','search_sum', 'search_sum_wechat', 'decoration_sum', 'decoration_sum_wechat', 'keep_sum', 'keep_sum_wechat',], 'number'],
            [['category_name'],'safe'],
            [['theme_name'],'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $dataProvider->setSort([   //添加-----排序
            'attributes' => [
                ...
                'search_sum' => [
                    'asc' => [Goods::tableName().'.search_sum' => SORT_ASC],
                    'desc' => [Goods::tableName().'.search_sum' => SORT_DESC],
                    'label' => 'search_sum'
                ],
                'search_sum_wechat' => [
                    'asc' => [Goods::tableName().'.search_sum_wechat' => SORT_ASC],
                    'desc' => [Goods::tableName().'.search_sum_wechat' => SORT_DESC],
                    'label' => 'search_sum_wechat'
                ],
                'decoration_sum' => [
                    'asc' => [Goods::tableName().'.decoration_sum' => SORT_ASC],
                    'desc' => [Goods::tableName().'.decoration_sum' => SORT_DESC],
                    'label' => 'decoration_sum'
                ],
                'decoration_sum_wechat' => [
                    'asc' => [Goods::tableName().'.decoration_sum_wechat' => SORT_ASC],
                    'desc' => [Goods::tableName().'.decoration_sum_wechat' => SORT_DESC],
                    'label' => 'decoration_sum_wechat'
                ],
                'keep_sum' => [
                    'asc' => [Goods::tableName().'.keep_sum' => SORT_ASC],
                    'desc' => [Goods::tableName().'.keep_sum' => SORT_DESC],
                    'label' => 'keep_sum'
                ],
                'keep_sum_wechat' => [
                    'asc' => [Goods::tableName().'.keep_sum_wechat' => SORT_ASC],
                    'desc' => [Goods::tableName().'.keep_sum_wechat' => SORT_DESC],
                    'label' => 'keep_sum_wechat'
                ],
            ]
        ]);
...
//        var_dump($this->id);die;
        ...
        $query->andFilterWhere([
            ...
            'search_sum' => $this->search_sum,
            'search_sum_wechat' => $this->search_sum_wechat,
            'decoration_sum' => $this->decoration_sum,
            'decoration_sum_wechat' => $this->decoration_sum_wechat,
            'keep_sum' => $this->keep_sum,
            'keep_sum_wechat' => $this->keep_sum_wechat,
        ]);
